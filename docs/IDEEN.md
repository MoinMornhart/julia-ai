...
| ⛔ – | (Entfernt) Öffentliche Webseite mit Live-Vorführung – zusammen mit dem separaten Repo `julia-ai-web` gelöscht; Downloads laufen jetzt über die GitHub-Releases von `julia-ai` |
...
| ✅ | **Videos schneiden/cutten (v5.3.0)** – Julia schneidet/trimmt Videos, fügt mehrere zusammen und erstellt Thumbnails; lokal per ffmpeg, jede neue Datei GELB freigegeben, abschaltbare Kategorie „Videos". (Weitere Ideen: einfache Übergänge, Untertitel.) | L | hoch | GELB |
