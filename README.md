...
- **Kein „leeres Fenster + Neustart-Schleife" mehr, und Einstellungen scrollen wieder** – zwei Fixe für zickige PCs: Beim Start bekommt die Oberfläche jetzt genug Zeit, sich zur Not mit Ersatz-Beschriftungen aufzubauen, bevor die Selbstheilung eingreift – das beendet die Neustart-Schleife auf betroffenen Rechnern (die echten Texte werden im Hintergrund nachgeladen). Und die Einstellungen lassen sich wieder mit dem Mausrad scrollen.
