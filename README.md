...
- **Leeres Fenster endgültig behoben** – die Beschriftungen der Oberfläche werden jetzt **sofort beim Start** aus mitgelieferten Texten gesetzt, ganz unabhängig davon, wie schnell der PC oder die Verbindung zum Hauptprogramm ist. Damit bleibt das Fenster auf keinem Rechner mehr leer und die Neustart-Schleife ist weg – der richtige Sprach-/Textsatz wird dann im Hintergrund nachgeladen.
...
- **Leeres Fenster auf langsamen PCs behoben** – auf manchen (langsamen oder mit zickigem Grafiktreiber) blieb das Hauptfenster leer und Julia startete in einer Schleife immer wieder neu. Ursache war kein Grafikproblem, sondern ein Wettlauf beim Start: Julia holte zwei Start-Infos nacheinander und die Selbstheilung schlug zu, bevor die Oberfläche fertig aufgebaut war. Jetzt lädt Julia beides parallel (schneller startklar) und wartet länger, bevor sie ein „leeres Fenster" annimmt – die Schleife ist weg.
