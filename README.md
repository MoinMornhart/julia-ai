...
- **Leeres Fenster endgültig gelöst – Not-Füllung der Oberfläche** – auf manchen PCs blieb das Fenster hartnäckig leer (nur der Rahmen, keine Beschriftungen), was in eine Neustart-Schleife führte. Ursache war **kein** Grafikproblem, sondern dass die Beschriftungen ausschließlich über einen empfindlichen Umweg im Fenster gefüllt wurden – kam der dort leer an, blieb alles leer. Jetzt füllt Julia die Oberfläche notfalls **direkt aus den mitgelieferten Texten** (unabhängig von diesem Umweg), sofort beim Laden und noch einmal, bevor sie überhaupt „leeres Fenster" annimmt. Damit ist das Fenster beschriftet, selbst wenn auf dem PC sonst etwas hakt – keine Neustart-Schleife mehr.
