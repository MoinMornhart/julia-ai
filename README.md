...
- **Werkzeuge abschalten macht Julia jetzt wirklich schneller** – abgeschaltete Werkzeuge werden der KI **gar nicht mehr angeboten** (vorher wurde nur ihre Nutzung blockiert, die Beschreibung aber weiter mitgeschickt – ohne Tempogewinn). Neu kannst du außerdem **ganze Gruppen** auf einmal ab-/anschalten (PC-Steuerung, Dateien, System, Gedächtnis …). Weniger Werkzeuge = schnellere, tokenschonendere Antworten. Kern-Funktionen bleiben immer an.
