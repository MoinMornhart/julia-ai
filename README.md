...
- **Minecraft: Steck-Stellen landen im Logbuch** – gibt Julia an einem Hindernis auf (statt endlos zu springen), notiert sie die Stelle mit Koordinaten im lokalen Spiel-Logbuch. So lässt sich hinterher genau sehen, wo sie hängen blieb – hilfreich, um solche Punkte gezielt zu verbessern. (Bleibt lokal auf dem PC.)
- **Minecraft: kein endloses Springen an einer Stelle mehr** – bleibt Julia beim selbst gesteuerten Vorlaufen an einem Hindernis hängen und kommt sie auch nach mehreren Sprüngen nicht voran, hört sie auf, dagegen zu drücken (statt endlos auf der Stelle zu springen); der nächste Schritt sucht dann einen neuen Weg. (Bei aktiver Wegfindung greift der Pathfinder wie bisher selbst.)
