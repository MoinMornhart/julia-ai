...
- **Julia antwortet spürbar schneller** – der Standard-Denkaufwand ist jetzt „mittel" statt „hoch": gute Antworten, aber deutlich flotter, statt langer Wartezeit. Wer bewusst tiefer nachdenken lassen will, stellt den **Denkaufwand** in den Einstellungen wieder höher (hoch/sehr hoch/maximal).
- **Denk-Schritt sichtbar beim Antworten** – während Julia nachdenkt, erscheint jetzt eine **eingeklappte Box** mit ihrem Reasoning (zum Aufklappen antippen), statt nur „arbeitet …". So siehst du, dass etwas passiert, auch wenn sie länger überlegt. Wie viel sie nachdenkt, stellst du weiterhin über den **Denkaufwand** in den Einstellungen ein.
