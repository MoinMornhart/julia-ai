...
- If you never want to be asked, switch on "Agree to everything" under **Approvals** in the settings – only by hand and after a confirmation; Julia cannot do it herself. Yellow actions then run without asking (and are logged). Red stays blocked, and after outside content Julia still asks before sending anything out or remembering it permanently.
